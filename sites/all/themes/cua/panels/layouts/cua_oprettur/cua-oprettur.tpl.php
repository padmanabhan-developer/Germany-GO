...
<div class="opret_tur">
               		<div class="opret_tur_left">
                        ...
                        <div class="row11">
                        	 ...
                        	 <input class="button24" type="submit" id="edit-submit4" name="op" value="FAHRT ERSTELLEN" disabled>
                        </div><!--close row11-->
                ...
                <?php print $content['mc3']; ?>
                    ...
                    <?php print $content['mc7']; ?>
                        <label id="kanikkebookes">Das Fahrrad ist beschäftigt in der gegebenen Zeit.</label>
...
//   $("#edit-field-tur-beboer-und").addClass('list3');
 ...
 //$("#edit-field-testlokation-und option").css("display","none");
   ...
   // $('#edit-field-testlokation-und option:first').text('Vælg lokation');
     $("<option value='0' disabled>ORT WÄHLEN</option>").insertBefore($('#edit-field-testlokation-und option:first'));
...
if (in_array('aktivitetsmedarbejder', $user->roles)) {
 ?>
  $("#edit-field-tur-kommentar-und-0-value").attr("placeholder", "Kommentare, Ideen und Anmerkungen zur Ausfahrt...");
<?php
   }
   else
   {
 ...
 $('#edit-field-tur-beboer-und option:first').text('WÄHLEN MITFAHRER');
...
<?php if (!$allow_only_edit_datetime) { ?>
$("#edit-field-tur-dato-und-0-value-timepicker-popup-1").val("Zeit WÄHLEN");
$("#edit-field-tur-dato-und-0-value2-timepicker-popup-1").val("Zeit WÄHLEN");
<?php } ?>


setInterval(function() { foo(); }, 100);

testtid1 = "Zeit WÄHLEN";
testtid2 = "Zeit WÄHLEN";
bookok = 0;
bookoktjek = 0;
