<div class="opret_tur">
               		<div class="opret_tur_left">
                        ...
                        <div class="row11">
                        	 ...
                        	 <input class="button24" type="submit" id="edit-submit4" name="op" value="BESTÄTIGEN FAHRT">
...
//   $("#edit-field-tur-beboer-und").removeAttr('multiple');
  ...
  $("#edit-field-tur-kommentar-und-0-value").attr("placeholder", "KOMMENTAR SCHREIBEN...");



 $('#edit-field-testlokation-und option:first').text('WÄHLEN Ort');
