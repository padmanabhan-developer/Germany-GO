                        ...
                        <h2><strong>HEIM ERSTELLEN</strong></h2>
                       ...
                       <div class="form_row5" id="hertur4">
                       		<label>PRAKTISCHE INFORMATIONEN</label>
...
<script type="text/javascript">
    ...
    $('#edit-field-godkendte-piloter').appendTo('#hertur1');
     ...
     $("#edit-body-und-0-value").attr("placeholder", "Praktische Informationen");

         $('<label>STRASSE</label>').appendTo('#hertur1a');
$('#edit-field-lokation-vejnavn-und-0-value').appendTo('#hertur1a');
     ...
     $("#edit-field-lokation-vejnavn-und-0-value").attr("placeholder", "Strasse");

         $('<label>HAUSNUMMER</label>').appendTo('#hertur2a');
     ...
     $("#edit-field-lokation-husnr-und-0-value").attr("placeholder", "Hausnummer");

         $('<label>PLZ</label>').appendTo('#hertur1b');
     ...
     $("#edit-field-lokation-postnr-und-0-value").attr("placeholder", "PLZ");
     ...
     $("#edit-field-lokation-by-und-0-value").attr("placeholder", "Ort");
 ...
 $('#edit-delete').appendTo('#hertur7');
     ...
     $("#edit-field-lokation-googlemaps-und-0-value").attr("placeholder", "Google Maps Adresse");
