<?php exit; ?>
    ...
    document.write('<a href="' + document.referrer + '">ZURÜCK</a>');
                        ...
                        <h2>ERSTELLEN <strong>BESKRIVELSE AF TUREN</strong></h2>
...
$('#edit-field-korttur-dato-und-0-value-datepicker-popup-0').val('<?php print $startdatetur; ?>');
$('#edit-field-korttur-dato-und-0-value-timepicker-popup-1').val('<?php print $starttidtur; ?>');
$('#edit-field-korttur-dato-und-0-value2-datepicker-popup-0').val('<?php print $startdatetur2; ?>');
$('#edit-field-korttur-dato-und-0-value2-timepicker-popup-1').val('<?php print $starttidtur2; ?>');
$('#edit-field-passager-navn-und-0-value').val('<?php print $passager; ?>');
$('#edit-field-tur-ref-und-<?php print $nodeturid ?>').attr('checked', true);

$('#edit-field-testlokation-und').val('<?php print $node->field_testlokation['und'][0]['target_id']; ?>');
$('#edit-field-rickshawpilot-uid-und-0-value').val('<?php print $node->field_tur_frivillig['und'][0]['uid']; ?>');
$('#edit-field-rickshawpilot-navn-und-0-value').val('<?php print $rickshawname; ?>');
$('#edit-field-passager-lokation-navn-und-0-value').val('<?php print $lokationnavn; ?>');

 <?php
$user_data = user_load($GLOBALS['user']->uid);
?>

$('#edit-field-kommunetesttax-und').val('<?php print $user_data->field_kommunetesttax['und'][0]['tid']; ?>');
