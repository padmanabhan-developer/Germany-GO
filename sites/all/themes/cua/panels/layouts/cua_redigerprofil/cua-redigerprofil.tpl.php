...
<div class="rediger_profil">
               		<h2 id="usrrow0"><strong>PROFIL ÄNDERN</strong></h2>
                    ...
                    <h3> <strong>KENNWORT</strong> ÄNDERN</h3>
                    <div class="form_row1">
                    ...
                    <h3><strong>ANGENOMMENE HEIME</strong></h3>
...
?>
  <li class="approved_lokations_li">
    ...
    <div class="button_div" onclick="return untag_approved_pilot(<?php echo $lokation_data_query->nid ?>,<?php echo $uid; ?>)">Dieses Heim verlassen</div>
